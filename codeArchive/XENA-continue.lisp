...
/* this controls boundaries for the initial buffer */

(# tab1 
	(collect 
		(bounded-walk -1 1 (loop (rv (* -1 (~ tableBounds)) (~ tableBounds)) (rv 3 40) (rv 3 7))) 
		441000))

/* do a bounded walk for 10 seconds, loop the steps */ 
