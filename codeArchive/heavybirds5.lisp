...
(fun a
	(t
		(ch 1.0 1.01 8.0 0.25 0.125 32.0)
		(fractRandTimer (ch 0.001 0.01 0.1 1.0 2.0 2.0))))

(clone 
(step-pan-gen
	 (index 
	 	(list 
		(latch (index-lin OSC.table9 (bounded-walk 0 512 a))  (rv 1000 1000))
	 	 ...
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (hold (rv -1 1) (rv 1 30)) (rv 1000 10000))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
