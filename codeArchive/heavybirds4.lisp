...
(step-pan-gen
	 (index 
	 	(list 
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.666667 1.5)) (fractRandTimer (ch 0.1 0.14 0.28 0.1 0.02  3.0 11.0)))) (st (rvfi 10000 441000)))
	 	 ...
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (loop (* (/ 1.0 (rf 1 130)) (ch -1 1)) (st 256) (st 9))  (rv 100 100000))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.5)) (fractRandTimer (ch 0.0003 0.002 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 ...
	 bah)
	(st 1)
	(line (seq 0 1) (fractRandTimer (ch 0.001 0.03 0.1 3 5 7 11 12)))
	)
5)
