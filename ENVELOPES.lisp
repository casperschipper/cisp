...
(osc-stream 
	historyPatch
	(/ 1.0 (line (seq (rv 10 300) 1000 1000 1000 1000) (ch 7 11)))
	:offset (line (rv b b) (st 10000))
	:duration (line (seq 0.1 1) (ch 3 7 11))
	:ratio 
		(seq
			(
				(tlatch (line (+ (ch 0.5 1.0 2.0) (rv 0.97 1.03)) (ch 3 4)) (rv 3 7))
				(tlatch (st 1.0) (rv 4 11))
				)
			
			)

	:channel (seq 1 2 3 4 5 6 7 8)
	:filter (reset (bounded-mup-walk 20 16000 (ch 0.5 2.0 4.0 8.0)) (st 440) (rv 5 25))
