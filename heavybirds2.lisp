...
(step-pan-gen
	 (index 
	 	(list 
	 	 ...
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 20 80 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 ...
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 400 14000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
	 	 (latch (cycle (t (bounded-mup-walk 9000 12000 (ch 0.5 2.0 1.1)) (fractRandTimer (ch 0.1 0.02  3.0 11.0)))) (st (rvfi 10 256)))
		 )
	 bah)
	(st 1)
