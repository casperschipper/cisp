...
(procedure r5
	(# amps (collect (* (exprv 0 1 5) (ch -1 1)) 4)))

(procedure r6
	(# amps (collect (ch -.1 .1) 4)))

(procedure r7
	(# amps (sine 4 (list 1.0))))
...
(procedure r14
	(# delays 
		(collect 
			(bounded-mup-walk
			(st 100) (st 4000) (ch 0.5 1.0 2.0 4.0)) 16)))
...
(fun indexer
	(index
		...
		(t
			(ch 0 1 2 2 2 2 2 2 2 2 2 2 2 2 3 4 5 6 6 6 6 6)
			(t (ch 0.002 .05 .1 .2 .3 4 8 10) (ch 0.01 .1 .2 4 5 7 8)))))
...
(pulse-fb-gen
	...
	(index
		(list 
			(index (list r1 r2 r3 r4 r5 r6 r7 r8 r9 r10 r22 r11 r12 r13 r14) (rv 0 16))
			(st 1.0)
			) (weights ((0 1) (1 1000))))
	) 3)