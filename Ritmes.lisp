...
(~ timert
	(line (seq 0.01 0.5) (line (seq 1 7) (st 13))))
...
(sci2
	...
	(~ timert)
	:gain (st 1)
	:pulseFreq (* (beat 83.35 1) (floor (ch 1 2 3 0.1 0.2)))
	:squareWindowFreq (ch 0.3 0.5)
	:width (ch 0.3 0.5 0.9)
	:cutoff 
		(reset 
			(bounded-mup-walk (st 50.0) (st 20000) 
				(ch 0.75 1.5)) (ch 220 440 660) (st 12))
	:duration (clip (/ 3 (~ timert)) 1 5)
