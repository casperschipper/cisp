...
(write OSC.table1 
	...
	(+ (hold (seq -1 1) (ch 3000 40 2)) (lookup OSC.table1 (line (seq -1 1 ) (/ 1.0 freq))) )


	(hold (count (table-cap OSC.table1)) (sometimes 100 1000 1)))
(st 1)
(hold (line (seq a a) (~ b)) (sometimes 1 1000 10))
)
