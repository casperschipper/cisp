...
SynthDef(\playLoopWidth, {
	| start = 0, loopfreq = 200, duration = 1.0, amp = 1.0, pan = 0.0,rate = 1.0,width = 0.1, speakOffset = 0 |
	var loopLength = 1.0 / loopfreq; // absolute length for the loopLength. for example: for 20 is 50ms or 0.05 sec.
	var env = EnvGen.ar( Env( [0, 1, 1, 0], [0.001, duration, 1.0], curve:[-3,-3,-9]),doneAction:2); // nothing to do.
